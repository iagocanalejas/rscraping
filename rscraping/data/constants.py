...
CATEGORIES = [CATEGORY_ABSOLUT, CATEGORY_VETERAN, CATEGORY_SCHOOL]
...
#  PENALTIES   #
################
BOAT_WEIGHT_LIMIT = "BOAT_WEIGHT_LIMIT"
COLLISION = "COLLISION"
COXWAIN_WEIGHT_LIMIT = "COXWAIN_WEIGHT_LIMIT"
CROSS_THE_FIELD = "CROSS_THE_FIELD"
DOPING = "DOPING"
LACK_OF_COMPETITIVENESS = "LACK_OF_COMPETITIVENESS"
NO_LINE_START = "NO_LINE_START"  # start without being grabbing the line
NULL_START = "NULL_START"
OFF_THE_FIELD = "OFF_THE_FIELD"  # incorrect arrival at the finish line
SINKING = "SINKING"
STARBOARD_TACK = "STARBOARD_TACK"  # incorrect tack
WRONG_LINEUP = "WRONG_LINEUP"
WRONG_ROUTE = "WRONG_ROUTE"  # incorrect route
...
SYNONYMS = {
    ...
    SYNONYM_PORT: ["PEIRAO COMERCIAL", "PUERTO", "PORTO", "PEIRAO", "MUELLE"],
    SYNONYM_BAY: ["BAIA", "BAHIA", "BAHÍA", "BAÍA"],
    SYNONYM_BEACH: ["PLAYA", "HONDARTZA", "PRAIA", "PLAGE", "PRAIA"],
