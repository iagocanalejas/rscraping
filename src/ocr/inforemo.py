...
from src.ocr._image import ImageOCR
from src.utils.constants import RACE_TRAINERA, GENDER_MALE, GENDER_FEMALE, GENDER_MIX, PARTICIPANT_CATEGORY_VETERAN, \
    PARTICIPANT_CATEGORY_ABSOLUT
from src.utils.models import RaceItem, OCR
from src.utils.normalization.times import normalize_lap_time
...
class ImageOCRInforemo(ImageOCR, source=OCR.INFOREMO):
    ...
    def get_category(self, data, **kwargs) -> str:
        modality = data[2]
